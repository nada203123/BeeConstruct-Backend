...
import com.dpc.chantierservice.config.AppProperties;
...
public class FileStorageService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.dpc.chantierservice.services.Document.FileStorageService.class);
